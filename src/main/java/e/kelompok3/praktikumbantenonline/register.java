...
import e.kelompok3.praktikumbantenonline.app.AppController;
import e.kelompok3.praktikumbantenonline.util.Server;
...
public class register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_username = (EditText) findViewById(R.id.email);
        txt_password = (EditText) findViewById(R.id.password);
        txt_confirm_password = (EditText) findViewById(R.id.confirmpass);
